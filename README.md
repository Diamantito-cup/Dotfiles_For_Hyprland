...
* **Midnight-Shell(a Caelestia-Shell Fork by Dim)**
...
Bueno, digamos que la instalación manual es MUY, larga, así que tiene su propia guia aparte **[Guia de instalación manual de los dotfiles](Guía-de-Instalación-Manual.md)**
...
<h3 align="center">Repos de Referencia</h3>

##### Hyprmod
---> **[HyprMod - A GTK Configuration APP For Hyprland](https://github.com/BlueManCZ/hyprmod.git)**

##### Midnight-Shell
---> **[Midnight-Shell a caelesstia shell fork by Dim](https://github.com/dim-ghub/midnight-shell.git)**

Coloco esto para que sepan cuales son las dependencias, la mayoría son conocidas, mas otras nó tanto :^
